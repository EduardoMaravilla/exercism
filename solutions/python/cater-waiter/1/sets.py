...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for name, ingredients_set in categories.items():
        if dish_ingredients.issubset(ingredients_set):
...
def singleton_ingredients(dishes, intersection):
    ...
    singletons = all_ingredients - intersection
