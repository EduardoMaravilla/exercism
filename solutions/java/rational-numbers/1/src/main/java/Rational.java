class Rational {
    ...
    int getDenominator() {
     ...
     public Rational add(Rational rational) {
        ...
        // Verificar si son opuestos aditivos
        if (a1 * b2 == -a2 * b1) {
            return new Rational(0, 1);
        }

        // Encontrar un denominador común para realizar la suma
    ...
    public Rational subtract(Rational rational) {
        ...
        // Encontrar un denominador común para realizar la resta
        int commonDenominator = b1 * b2;
        int newNumerator = a1 * b2 - a2 * b1;
    ...
    public Rational multiply(Rational rational) {
        ...
        // Si uno de los racionales es cero, el resultado siempre es cero
        if (a1 == 0 || a2 == 0) {
            return new Rational(0, 1);
        }
    ...
    public Rational pow(int pow) {
        int a1 = (int) Math.pow(this.numerator, pow);
        int b1 = (int) Math.pow(this.denominator, pow);
        return new Rational(a1, b1);
    }
    ...
    private int calcularMCD(int a, int b) {
        // Asegurarnos de que los números sean positivos
        a = Math.abs(a);
        b = Math.abs(b);
